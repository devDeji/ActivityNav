...
import com.example.ayodeji.myapplication.DubaiFragment.OnListFragmentInteractionListener;
import com.example.ayodeji.myapplication.dubai.DubaiContent.DummyItem;
 ...
 */
public class MyDubaiRecyclerViewAdapter extends RecyclerView.Adapter<MyDubaiRecyclerViewAdapter.ViewHolder> {

    private final List<DummyItem> mValues;
    private final OnListFragmentInteractionListener mListener;

    public MyDubaiRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_dubai, parent, false);
