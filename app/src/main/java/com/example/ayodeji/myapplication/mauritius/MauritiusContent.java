package com.example.ayodeji.myapplication.mauritius;
...
public class MauritiusContent {
    ...
    private static String getContent(int position) {
        ...
        switch (position) {
            case 1:
                content = "http://www.middlesex.mu/";
                break;
            case 2:
                content = "https://www.facebook.com/MiddlesexUniversityMauritius/";
                break;
            case 3:
                content = "https://twitter.com/mdx_mtius";
                break;
            default:
    ...
    private static String makeDetails(int position) {
        ...
        switch (position) {
            case 1:
                linkName = "Mauritius Website";
                break;
            case 2:
                linkName = "Mauritius Facebook Page";
                break;
            case 3:
                linkName = "Mauritius Twitter Page";
                break;
            default:
                linkName = "Website";
                break;
