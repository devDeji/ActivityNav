package com.example.ayodeji.myapplication.dubai;
...
public class DubaiContent {
    ...
    private static String getContent(int position) {
        ...
        switch (position) {
            case 1:
                content = "http://www.mdx.ac.ae/";
                break;
            case 2:
                content = "https://www.facebook.com/MiddlesexDubai/";
                break;
            case 3:
                content = "https://twitter.com/MiddlesexDubai";
                break;
            default:
                content = "https://www.facebook.com/MiddlesexDubai/";
                break;
    ...
    private static String makeDetails(int position) {
        ...
        switch (position) {
            case 1:
                linkName = "Dubai Website";
                break;
            case 2:
                linkName = "Dubai Facebook Page";
                break;
            case 3:
                linkName = "Dubai Twitter Page";
                break;
            default:
                linkName = "Website";
                break;
